...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="w-full max-w-6xl mx-auto flex h-16 items-center justify-between px-4">
          ...
          <nav className="flex items-center space-x-6">
            ...
            <a href="#projetos" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Projetos</a>
            <a href="#musica" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Música</a>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden py-24 md:py-32 w-full flex justify-center">
        ...
        <div className="relative w-full max-w-4xl px-4 text-center">
          ...
          <p className="mt-6 text-xl text-muted-foreground text-balance max-w-2xl mx-auto">
            Olá! Sou um estudante de programação apaixonado por tecnologia e música. Neste site, eu juntei minhas paixões criando experiências digitais e expressões artísticas.
          </p>
        </div>
      </section>

      {/* About Section */}
      <section id="sobre" className="py-24 w-full">
              ...
              <Card className="border-primary/30 bg-gradient-to-br from-primary/5 to-transparent">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    Estudante focado em desenvolvimento web moderno, criando aplicações funcionais, rápidas e dinâmicas
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">HTML5</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">CSS3</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">JavaScript</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">TypeScript</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">React</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">Next.js</Badge>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-3 text-primary">Backend & Ferramentas</h4>
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">Node.js</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">Git</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">GitHub</Badge>
                      <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30">VS Code</Badge>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-3 text-primary">Aprendendo</h4>
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="outline" className="border-primary/50 text-muted-foreground">Python</Badge>
                      <Badge variant="outline" className="border-primary/50 text-muted-foreground">PostgreSQL</Badge>
                      <Badge variant="outline" className="border-primary/50 text-muted-foreground">Docker</Badge>
                      <Badge variant="outline" className="border-primary/50 text-muted-foreground">AWS</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="border-border/50">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Apaixonado por Hip-hop e Rap, uso a música para expressar ideias e sentimentos de forma criativa e autêntica.
                </p>
                <div className="flex flex-wrap gap-2">
      ...
      <section id="projetos" className="py-24 bg-card/30 w-full">
        <div className="w-full max-w-6xl mx-auto px-4">
          ...
          <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-1 max-w-md mx-auto">
            <a href="https://meu-site-de-apresenta-o.vercel.app" target="_blank" rel="noopener noreferrer">
              <Card className="group hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 border-border/50 cursor-pointer">
                <CardHeader>
      ...
      {/* Music Projects */}
      <section id="musica" className="py-24 w-full">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="group hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 border-border/50">
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <Image src="/foto2.png" alt="Projeto Musical 1" width={80} height={80} className="rounded-md object-cover" />
                    <Button size="sm" className="absolute inset-0 m-auto h-8 w-8 rounded-full p-0 opacity-0 group-hover:opacity-100 transition-opacity" asChild>
                      <a href="https://open.spotify.com/track/7tkPm7LoiW4BlHGsoEUHh5" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Minha primeira produção musical disponível no Spotify</p>
                  </div>
            ...
            <Card className="group hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 border-border/50">
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <Image src="/foto3.png" alt="Projeto Musical 2" width={80} height={80} className="rounded-md object-cover" />
                    <Button size="sm" className="absolute inset-0 m-auto h-8 w-8 rounded-full p-0 opacity-0 group-hover:opacity-100 transition-opacity" asChild>
                      <a href="https://open.spotify.com/track/4yawlNqB3t45dnqYyTV4aO" target="_blank" rel="noopener noreferrer">
                        <Play className="h-4 w-4" />
                      </a>
                    </Button>
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Evolução artística com letras mais elaboradas</p>
                  </div>
                  <Button variant="ghost" size="sm" asChild>
                    <a href="https://open.spotify.com/track/4yawlNqB3t45dnqYyTV4aO" target="_blank" rel="noopener noreferrer">
                      <ExternalLink className="h-4 w-4" />
      ...
      {/* Contact Section */}
      <section id="contato" className="py-24 bg-card/30 w-full">
      ...
      {/* Footer */}
      <footer className="border-t border-border bg-card/50 py-12 w-full">
        <div className="w-full max-w-4xl mx-auto px-4">
